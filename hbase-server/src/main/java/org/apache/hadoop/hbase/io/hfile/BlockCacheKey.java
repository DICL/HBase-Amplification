...
public class BlockCacheKey implements HeapSize, java.io.Serializable {
  ...
  private final boolean isIncludeTags;
  private final boolean isIncludeMemStoreTS;
  private final boolean isDecodeMemstoreTS;
  ...
  public BlockCacheKey(String hfileName, long offset, boolean isPrimaryReplica, BlockType blockType) {
    ...
    this.isIncludeTags = false;
    this.isIncludeMemStoreTS = false;
    this.isDecodeMemstoreTS = false;
  }

  public BlockCacheKey(String hfileName, long offset, boolean isPrimaryReplica, BlockType blockType,
    boolean isIncludeTags, boolean isIncludeMemStoreTS, boolean isDecodeMemstoreTS) {
    this.isPrimaryReplicaBlock = isPrimaryReplica;
    this.hfileName = hfileName;
    this.offset = offset;
    this.blockType = blockType;
    this.isIncludeTags = isIncludeTags;
    this.isIncludeMemStoreTS = isIncludeMemStoreTS;
    this.isDecodeMemstoreTS = isDecodeMemstoreTS;
  }

  public boolean getIncludeTags() {
    return this.isIncludeTags;
  }

  public boolean getIncludeMemStoreTS() {
    return this.isIncludeMemStoreTS;
  }

  public boolean getDecodeMemstoreTS() {
    return this.isDecodeMemstoreTS;
  }
