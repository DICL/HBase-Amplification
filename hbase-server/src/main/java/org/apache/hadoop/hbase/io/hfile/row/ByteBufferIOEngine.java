...
/*
  @Override
  public Cacheable read(RowEntry be) throws IOException {
...
*/
  @Override
  public ByteBuffer[] read(long offset, int vLength) throws IOException {
    ByteBuffer[] buffers = bufferArray.asSubByteBuffers(offset, vLength);
    return buffers;
  }
  /**
