...
public class HRegion implements HeapSize, PropagatingConfigurationObserver, Region {
  ...
  */
  ...
  class RegionScannerImpl
    ...
    //DICL Modification
    private int regionScannerSize = 0;
    private int regionScannerAmp = 0;
    ...
    RegionScannerImpl(Scan scan, List<KeyValueScanner> additionalScanners, HRegion region,
      ...
      InitTime.add(EndInitTime - StartInitTime);
    }
    ...
    protected void initializeScanners(Scan scan, List<KeyValueScanner> additionalScanners)
	  ...
	  InitTime.add(scanner.InitTime());
	  SeekTime.add(scanner.SeekTime());
	  //scanner.classString(); //DICL Modification
          //DICL Modification
	  int storeScannerInfo = store.storeScannerInfo();
	  if (storeScannerInfo != 0){
		  regionScannerSize = regionScannerSize + storeScannerInfo;
		  if (storeScannerInfo > 1)
			  regionScannerAmp = storeScannerInfo - 1;
	  }
    ...
    public int regionScannerInfo(){
	    return this.regionScannerSize;
    }

    public int ScannerAmp(){
	    return this.regionScannerAmp;
    }
